...
![Page 1 - Zomato Restaurant Analytics](screenshots/page-1-dashboard.png)
...
If Power BI asks for the dataset location, update the Excel file path in the data source settings.
Refresh the data if required.
Use the slicers on the left side to filter the dashboard.
Navigate between the two report pages using the tabs at the bottom.
Hover over charts and data points to view additional information.
